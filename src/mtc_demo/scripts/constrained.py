...
def create_constrained():
    ...
    mps = stages.ModifyPlanningScene("add_obstacle")
    mps.addObject(co)
    ...
    pose.orientation.x = pose.orientation.w = 0.70711
    mps.addObject(co)
    ...
    move.setDirection(Vector3Stamped(header, Vector3(0.0, 0.4, 0.0)))
    ...
    oc.link_name = "object"
    oc.orientation.x = oc.orientation.w = 0.70711
